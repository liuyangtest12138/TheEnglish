...
public class YouDaoUtil {
    ...
    public static String fanYI(String content,String f,String t){
        String appKey ="3894982a1bee8c33";
        String query = content;
        String salt = String.valueOf(System.currentTimeMillis());
        String from = f;
        String to = t;
        String sign = md5(appKey + query + salt+ "azGyDKCnOAlIA2c0DRxlfsF5OHSUVTOh");
